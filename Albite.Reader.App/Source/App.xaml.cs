...
using Albite.Reader.App.View.Transition;
using System;
using System.Windows;
using System.Windows.Navigation;
using AlbiteTransitionFrame = Albite.Reader.App.View.Transition.TransitionFrame;
...
namespace Albite.Reader.App
{
    public partial class App : Application, IApplication
    {
        ...
        private Context context = new Context("Library/", "Albite.sdf");
        public Context CurrentContext { get { return context; } }

        /// <summary>
        /// Helper function that returns the Context
        ...
        public static Context Context
        {
            get
            {
                return ((IApplication) Current).CurrentContext;
            }
        }
