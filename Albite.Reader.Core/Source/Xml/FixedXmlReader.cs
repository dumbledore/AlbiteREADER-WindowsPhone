...
namespace Albite.Reader.Core.Xml
{
    /// <summary>
    ...
    /// to be an XmlComment.
    /// </summary>
    public class FixedXmlReader : XmlReader
    {
        XmlReader reader;

        public FixedXmlReader(Stream stream) : this(stream, new XmlReaderSettings()) { }

        public FixedXmlReader(Stream stream, XmlReaderSettings settings)
        {
