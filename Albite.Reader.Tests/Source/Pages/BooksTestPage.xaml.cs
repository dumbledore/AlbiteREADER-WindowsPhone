...
namespace Albite.Reader.Tests.Pages
{
    public partial class BooksTestPage : PhoneApplicationPage
    {
        ...
        {
            return ((IApplication)App.Current).CurrentContext;
        }
        ...
        private void BookButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Navigate
            NavigationService.Navigate(new Uri("/Albite.Reader.App;component/Source/View/Pages/ReaderPage.xaml?id=" + button.Id, UriKind.Relative));
        }
